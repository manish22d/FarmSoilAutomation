...
formatter.result({
  "duration": 76490045800,
  "error_message": "java.util.NoSuchElementException: No value present\r\n\tat java.util.Optional.get(Optional.java:135)\r\n\tat com.BDD.ui.pages.TerminalPage.getSubDevices(TerminalPage.java:79)\r\n\tat com.BDD.testSteps.UITestSteps.verify_all_coressponding_device_id_displayed_correctly_in_UI(UITestSteps.java:53)\r\n\tat ✽.Then verify all coressponding device id displayed correctly in UI(UI.feature:9)\r\n",
  "status": "failed"
});
});